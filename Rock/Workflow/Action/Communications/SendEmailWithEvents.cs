...
namespace Rock.Workflow.Action
{
    ...
    public class SendEmailWithEvents : ActionComponent
    {
                            ...
                            case "Rock.Field.Types.PersonFieldType":
                                {
                                    ...
                                    if ( !personAliasGuid.IsEmpty() )
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            Send( recipients, fromPerson, fromEmailAddress, fromName, subject, body, createCommunicationRecord, metaData );
                                        }
                                    }
                                    break;
                                }
        ...
        private void Send( string recipientEmails, Person fromPerson, string fromEmail, string fromName, string subject, string body, Dictionary<string, object> mergeFields, bool createCommunicationRecord, Dictionary<string, string> metaData )
        {
            ...
            Send( recipients, fromPerson, fromEmail, fromName, subject, body, createCommunicationRecord, metaData );
        }
        ...
        /// <param name="createCommunicationRecord">if set to <c>true</c> [create communication record].</param>
        /// <param name="metaData">The meta data.</param>
        private void Send( List<RockEmailMessageRecipient> recipients, Person fromPerson, string fromEmail, string fromName, string subject, string body, bool createCommunicationRecord, Dictionary<string, string> metaData )
        {
