...
namespace Rock.Migrations
{
    ...
    public partial class AddedSmsPipelineAndUpdatedSmsAction : Rock.Migrations.RockMigration
    {
        ...
        private void UpdatePageAndBlockSettings()
        {
            ...
            // Attrib for BlockType: Sms Pipeline List:SMS Pipeline Details
            RockMigrationHelper.AddOrUpdateBlockTypeAttribute( "DB6FD0BF-FDCE-48DA-919C-240F029518A2", "BD53F9C9-EBA9-4D3F-82EA-DE5DD34A8108", "SMS Pipeline Details", "SMSPipelineDetails", "SMS Pipeline Details", @"", 0, @"", "FA40D714-9D6F-4620-97B1-07BFFFC08F96" );
            ...
            // Attrib Value for Block:SMS Pipeline List, Attribute:SMS Pipeline Details Page: SMS Pipeline, Site: Rock RMS
        ...
        private void RemovePageAndBlockSettings()
        {
            ...
            // Remove Block: SMS Pipeline Details, from Page: SMS Pipeline Details, Site: Rock RMS
