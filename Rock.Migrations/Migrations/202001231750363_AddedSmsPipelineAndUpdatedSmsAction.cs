...
namespace Rock.Migrations
{
    ...
    public partial class AddedSmsPipelineAndUpdatedSmsAction : Rock.Migrations.RockMigration
    {
        ...
        private void UpdatePageAndBlockSettings()
        {
            ...
            RockMigrationHelper.UpdateBlockType( "SMS Pipeline Detail", "Configures the pipeline that processes an incoming SMS message.", "~/Blocks/Communication/SmsPipelineDetail.ascx", "Communication", "44C32EB7-4DA3-4577-AC41-E3517442E269" );
