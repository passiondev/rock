...
namespace Rock.Migrations
{
    ...
    public partial class SundayDate : Rock.Migrations.RockMigration
    {
        ...
        public override void Up()
        {
            ...
            AlterColumn("dbo.AttendanceOccurrence", "SundayDate", c => c.DateTime(nullable: false, storeType: "date"));
            AlterColumn("dbo.FinancialTransaction", "SundayDate", c => c.DateTime(storeType: "date"));
