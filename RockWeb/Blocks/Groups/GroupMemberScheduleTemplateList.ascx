<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupMemberScheduleTemplateList.ascx.cs" Inherits="RockWeb.Blocks.Groups.GroupMemberScheduleTemplateList" %>
