<%@ Control Language="C#" AutoEventWireup="true" CodeFile="GroupMemberScheduleTemplateDetail.ascx.cs" Inherits="RockWeb.Blocks.Groups.GroupMemberScheduleTemplateDetail" %>
