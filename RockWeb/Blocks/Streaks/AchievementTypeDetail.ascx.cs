...
namespace RockWeb.Blocks.Streaks
{
    ...
    public partial class AchievementTypeDetail : RockBlock, IDetailBlock
    {
        ...
        private void SaveRecord()
        {
            ...
            if ( !isNew )
            {
                var eligibleAchievementTypes = StreakTypeAchievementTypeService.GetEligiblePrerequisiteAchievementTypeCaches( achievementType.Id );
        ...
        private void SyncPrerequisiteList()
        {
            ...
            var eligiblePrerequisites = isNew ?
                StreakTypeAchievementTypeService.GetEligiblePrerequisiteAchievementTypeCaches() :
                StreakTypeAchievementTypeService.GetEligiblePrerequisiteAchievementTypeCaches( achievementType.Id );
            ...
            if ( !isNew )
            {
                cblPrerequsities.SetValues( achievementType.Prerequisites.Select( statp => statp.PrerequisiteStreakTypeAchievementTypeId ) );
            }
        }
